                    ...
                    <div className='container' style={{width:"90%"}}>
                        {listDirecciones.map((item,index) => (
                            <div key={index} className="row">
                                ...
                                <div className="col-1" style={{alignItems:"flex-end",justifyContent:"flex-end",display:"flex"}}>
                                    <MdDelete style={{fontSize:40}} className='btnFav' onClick = {() => { methodModalDelDireccion(item.id)} }  ></MdDelete>
                                </div>
                            </div>
                        ))}
